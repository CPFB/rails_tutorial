...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /welcome to the twitter clone/i
      end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New User", :email => "newuser@example.com", :password => "barbaz", :password_confirmation => "barbaz" }
      end
  ...
  describe "authentication of edit/update user pages" do
    before(:each) do
      @user = Factory(:user)
    end
  ...
  describe "GET 'index'" do
    ...
    describe "for signed-in users" do
      ...
      it "should not allow non-admin users to see delete links" do
        get :index
    ...
    describe "for admin users" do
      it "should allow admin users to see delete links" do
